...
<div>
<h2>Party List</h2>
<td><a href="/party/create"><i class="fa fa-plus-square" aria-hidden="true"></i></a></td>
</div>
...
<td>
  @if($party->logo)
   <img class="img-thumbnail" src="{{asset($party->logo)}}" width="100px" height="auto" >
     @else
     No Logo
     @endif
    </td>

<td ><a href="/party/{{$party->id}}/show"><i class="fa fa-eye" style="color:#00ccff;" aria-hidden="true"></i>
</button></a></td>
<td>
<a href="/party/{{$party->id}}/edit"><i class="fa fa-pencil" style="color:lime;margin-right:20px;" aria-hidden="true"></i>
</button></a></td>

<td>
<form  action='/party/{{$party->id}}/delete' method='POST'>
@csrf()
@method('delete')
